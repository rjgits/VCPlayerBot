...
async def start(client, message):
    ...
    buttons = [
        [
            InlineKeyboardButton('help admin ', url='https://t.me/amrjsingh'),
            InlineKeyboardButton('🧩 Source', url='https://github.com/rjgits/VCPlayerBot')
        ],
        [
...
async def repo_(client, message):
    buttons = [
        [
            InlineKeyboardButton('chat with rj', url='https://t.me/amrjsingh'),
            InlineKeyboardButton('⚙️ Update Channel', url='https://t.me/amrjsingh'),     
        ],
        [
            InlineKeyboardButton('🗑 Close', callback_data='close'),
        ]
    ]
    await message.reply("<b>thanks for using</b>", reply_markup=InlineKeyboardMarkup(buttons), disable_web_page_preview=True)
    await delete_messages([message])
